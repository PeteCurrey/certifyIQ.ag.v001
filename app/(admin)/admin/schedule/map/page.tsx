...
// Dynamically import MapView to skip SSR (Leaflet requires window)
const MapView = dynamic(() => import('@/components/admin/MapView'), { ssr: false, loading: () => <div className={styles.mapLoading}>Loading map…</div> })
    ...
    <div className={styles.container}>
      ...
      <div className={styles.layout}>
        ...
        <div className={styles.sidebar}>
          <span className={styles.sidebarTitle}>{jobs.length} jobs on {format(parseISO(filterDate + 'T12:00:00'), 'dd MMM yyyy')}</span>

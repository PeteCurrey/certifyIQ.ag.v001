...
const TERMS: Term[] = [
  ...
  { letter: 'E', term: 'EPC', definition: 'Energy Performance Certificate. A legally required document showing a property\'s energy efficiency rating from A to G, valid for 10 years.', related: { text: 'EPC Lookup', href: '/epc-register' } },
  { letter: 'E', term: 'EPC Register', definition: 'The official government database of all lodged EPCs in England and Wales, accessible at epc.opendatacommunities.org.', related: { text: 'Search EPCs', href: '/epc-register' } },

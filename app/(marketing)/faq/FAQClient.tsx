...
const FAQS = [
  ...
  { cat: 'About EPCs', q: 'Can I see anyone else\'s EPC?', a: 'Yes — all lodged EPCs in England and Wales are on the public register. You can search by postcode. Our free EPC Lookup tool makes this even easier.', cta: { text: 'Search the EPC Register', href: '/epc-register' } },
